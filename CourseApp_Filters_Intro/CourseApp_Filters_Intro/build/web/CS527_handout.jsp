...
<html>
    <head>
        ...
        <title>CS527 Handout Page</title>
    </head>
    <body>
        <%
        ...
        <table cellpadding="5" border="1">
            ...
            <tr><td>Week 1</td>
                <td><a href="/courses/cs527/<%=courseNo%>/week1.pdf">Handout for Week1</a></td>
            </tr>
            <tr><td>Week 2</td>
                <td><a href="/courses/cs527/<%=courseNo%>/week2.pdf">Handout for Week2</a></td>
            </tr>
        </table>
