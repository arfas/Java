...
public class Server1 {
	 ...
	 * @return boolean
	 */
	 static boolean validPort(Integer x) {
	...
	public static void main(String args[]) throws Exception {
		...
		// Print welcome msg
		System.out.println(Server1.welcomeMsg);

		// Set port
		Server1.port = Server1.getPort();

		// Create new server socket & dump out a status msg
		ServerSocket welcomeSocket = new ServerSocket(Server1.port);
