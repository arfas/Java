...
import static mohammed_arfa_adeeb_16610_cs532.c._hw3.BigNumberConstants.CONTINUE;
...
public class Server extends JFrame implements BigNumberConstants {   
/**
 *
 * @author arfas
 */
...
class HandleASession1 implements Runnable, BigNumberConstants {
     ...
     * Construct a thread
     */
    public HandleASession1(Socket player1, Socket player2) {
    ...
    public void run() {
      ...
      // Continuously serve the players and determine and report
            ...
            while (true) {
                ...
                String text=fromPlayer1.toString();
                cell[row][column] = 'X';
                ...
                if (isWon('X')) {
                    ...
                    sendMove(toPlayer2, row, column,text);
                ...
                if (isWon('O')) {
                    ...
                    sendMove(toPlayer1, row, column,text);
                    break;
                } else {
     ...
     */
    private void sendMove(DataOutputStream out, int row, int column, String text)
            throws IOException {
