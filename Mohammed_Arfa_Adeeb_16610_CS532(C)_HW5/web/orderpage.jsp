<%-- 
    Document   : orderpage
    Created on : Dec 8, 2016, 11:46:22 AM
    Author     : arfas
--%>
  ...
  <a href="http://localhost:8080/Mohammed_Arfa_Adeeb_16610_CS532_C__HW5/checkout.jsp">
    <button>Checkout Page</button>
        ...
        <div id="conformationpage" class="tabcontent">
            <a href="http://localhost:8080/Mohammed_Arfa_Adeeb_16610_CS532_C__HW5/conformationpage.jsp"></a>
    ...
    evt.currentTarget.className += " active";
        ...
        <br>
   <h1>Order Page</h1>
   <form method="post" action="conformationpage.jsp">
    Item name:<input type="text" name="iname" ><br>
    Quantity:<input type="text" name="iqty" ><br>
      <a href="http://localhost:8080/Mohammed_Arfa_Adeeb_16610_CS532_C__HW5/checkout.jsp">
      <input type="submit" value="checkout"/>
      </a>
   </form>
   <form action="Servelet">
